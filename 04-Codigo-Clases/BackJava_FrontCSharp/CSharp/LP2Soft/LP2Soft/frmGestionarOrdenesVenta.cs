...
namespace LP2Soft
{
    public partial class frmGestionarOrdenesVenta : Form
    {
        ...
        public frmGestionarOrdenesVenta(Empleado empleado)
        {
            InitializeComponent();
        ...
        {
            frmBusquedaOrdenesVenta fov = new frmBusquedaOrdenesVenta();
            if (fov.ShowDialog() == DialogResult.OK)
            {
                _ordenVenta = fov.OrdenVentaSeleccionada;
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            _ordenVenta.Empleado = _empleado;

            int resultado = _daoOrdenVenta.insertar(_ordenVenta);
            if (resultado != 0)
            {
                MessageBox.Show("Se ha registrado con exito", "Mensaje de Confirmación");
            }
        }
